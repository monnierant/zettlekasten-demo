...
__export(types_exports, {
  ...
  Direction: () => Direction,
  commandsToCreate: () => commandsToCreate
});

// icons.ts
var arrow_down_from_line = `<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-down-from-line"><path d="M19 3H5"/><path d="M12 21V7"/><path d="m6 15 6 6 6-6"/></svg>`;
var arrow_up_from_line = `<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-up-from-line"><path d="m18 9-6-6-6 6"/><path d="M12 3v14"/><path d="M5 21h14"/></svg>`;
var arrow_right_from_line = `<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right-from-line"><path d="M3 5v14"/><path d="M21 12H7"/><path d="m15 18 6-6-6-6"/></svg>`;
var arrow_down_narrow_wide = `<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-down-narrow-wide"><path d="m3 16 4 4 4-4"/><path d="M7 20V4"/><path d="M11 4h4"/><path d="M11 8h7"/><path d="M11 12h10"/></svg>`;

// src/types.ts
var import_obsidian = require("obsidian");
__reExport(types_exports, require("obsidian"));
var Direction = /* @__PURE__ */ ((Direction2) => {
  Direction2[Direction2["Up"] = 0] = "Up";
  Direction2[Direction2["Down"] = 1] = "Down";
  Direction2[Direction2["SelDown"] = 2] = "SelDown";
  Direction2[Direction2["SelUp"] = 3] = "SelUp";
  Direction2[Direction2["Left"] = 4] = "Left";
  Direction2[Direction2["Right"] = 5] = "Right";
  Direction2[Direction2["RightDown"] = 6] = "RightDown";
  return Direction2;
})(Direction || {});
...
(0, import_obsidian.addIcon)("arrow-up-from-line", arrow_up_from_line);
(0, import_obsidian.addIcon)("arrow-right-from-line", arrow_right_from_line);
...
// src/settings.ts
var DuplicateLineSettings = class extends import_obsidian2.PluginSettingTab {
    ...
    commandsToCreate.forEach((commandConfig) => {
      ...
      setting.addToggle((toggle) => {
        toggle.setValue(
          ...
          if (this.plugin.settings[commandConfig.condition]) {
            const condition = commandConfig.condition;
            this.plugin.addCommandToEditor(commandConfig, condition);
          } else {
            await this.app.commands.removeCommand(`duplicate-line:${commandConfig.id}`);
          }
          await this.plugin.saveSettings();
        });
      });
...
function selectionToLine(editor, selection, direction) {
  ...
  } else if (direction === 2 /* SelDown */ || direction === 3 /* SelUp */ || direction === 6 /* RightDown */) {
...
function isNoSelection(selection) {
  const { anchor, head } = selection;
  return anchor.ch === head.ch && anchor.line === head.line;
}
function selectionToRange(selection, sort) {
  const positions = [selection.anchor, selection.head];
  let sorted = positions;
  if (sort) {
    sorted = (0, import_lodash.sortBy)(positions, ["line", "ch"]);
  }
  return {
    from: sorted[0],
    to: sorted[1]
...
function rangeToPositions(range) {
...
var getSelectionContent = (ed, selections) => {
  ...
  if (wordRange != null) {
    ...
    const isWordSelected = from.line === lastSelection.anchor.line && from.ch === lastSelection.anchor.ch && to.line === lastSelection.head.line && to.ch === lastSelection.head.ch;
...
// src/AddAllOccurrences.ts
var addAllOccurrences = (editor) => {
  let selections = editor.listSelections();
...
var DuplicateLine = class extends import_obsidian6.Plugin {
  constructor() {
      ...
      for (let selection of selections) {
        ...
        switch (direction) {
          ...
          case 2 /* SelDown */: {
            newAnchor = {
              line: anchor.line + addedLines,
              ch: isEmptySelection ? 0 : sameDirection ? 0 : numberOfLines === 1 ? content.length : anchorLength
            };
            newHead = {
              line: head.line + addedLines,
              ch: isEmptySelection ? headLength : sameDirection ? numberOfLines === 1 ? content.length : headLength : 0
            };
          ...
          case 3 /* SelUp */: {
            ...
            newHead = {
              line: sameDirection ? anchor.line + addedLines - 1 : head.line + addedLines - numberOfLines,
    ...
    this.directionalMove = (editor, direction) => {
  ...
  createCommandsFromSettings() {
    commandsToCreate.forEach((commandConfig) => {
      const condition = commandConfig.condition;
      const conditionValue = this.settings[condition];
      if (conditionValue) {
        this.addCommandToEditor(commandConfig, condition);
      }
    });
  }
  addCommandToEditor(commandConfig, condition) {
    this.addCommand({
      id: commandConfig.id,
